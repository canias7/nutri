...
/**
 * Body measurements, as a section rather than a page of their own.
 *
 * They belong with the rest of the standing facts about someone — height,
 * starting weight, goal — not in the daily rhythm the nav is otherwise about.
 */
